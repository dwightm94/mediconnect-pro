        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6">
          <div className="flex items-center justify-between h-16">
            ...
            <div className="flex items-center gap-3">
              <span className="hidden sm:inline-block px-3 py-1 bg-[rgba(10,110,110,0.1)] text-[#0A6E6E] text-xs font-semibold rounded-full uppercase">
                Provider
              </span>
              <div className="flex items-center gap-2">
                <div className="w-8 h-8 rounded-full bg-gradient-to-br from-[#0A6E6E] to-[#054848] flex items-center justify-center text-white text-sm font-bold">
